...
import { CompletedMangaResponse } from './types/completed'

export default function CompletedContent({ mangaData }: { mangaData: CompletedMangaResponse }) {
        ...
        <section className='py-10 sm:py-16'>
            ...
            <div className="container px-4 flex flex-col gap-6 md:gap-8">
                <div className='flex justify-between items-center gap-4 border-b border-gray-200 dark:border-gray-700 pb-4 md:pb-6'>
                    <h3 className='text-xl md:text-2xl font-bold text-gray-900 dark:text-white'>Completed Manga</h3>
                    <Link href={"/manga/completed"} onClick={handleLinkClick} className='text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors duration-200 font-medium flex items-center gap-2'>
                        Lihat Semua
                        ...
                        <div className="flex gap-3 sm:gap-4">
                            {mangaData.data.animeList.map((manga, idx) => (
                                ...
                                >
                                    <Link
                                        href={manga.href}
                                        className="block w-[200px] sm:w-[240px] lg:w-[300px]"
