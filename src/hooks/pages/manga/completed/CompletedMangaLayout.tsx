...
export default function CompletedMangaLayout({ mangaData }: MangaContentProps) {
    ...
    const handlePageChange = useCallback(async (page: number) => {
        try {
            ...
            router.push(`/manga/completed?page=${page}`);

            const response = await fetch(`/api/manga/completed?page=${page}`, {
                headers: {
        ...
        <section className='py-16 z-50'>
            ...
            <div className='container px-4'>
                <div className='flex mb-12 flex-col gap-2'>
                    <h3 className='text-4xl font-bold text-gray-900 dark:text-white tracking-tight'>Completed Manga</h3>
                    <p className='text-gray-600 dark:text-gray-400 mt-3 text-lg'>Explore our collection of completed manga</p>
                </div>
