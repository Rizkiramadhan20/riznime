...
import { GenreResponse } from '@/hooks/pages/manga/genres/types/genres';
...
export default function CategoryContent({ mangaData }: CategoryContentProps) {
