...
export default function AnimeContent({ animeData }: AnimeContentProps) {
    ...
    const handlePageChange = useCallback(async (page: number) => {
        try {
            ...
            router.push(`/donghua/ongoing?page=${page}`);
        ...
        <section className='py-10 bg-gray-50 dark:bg-gray-900 z-50'>
            ...
            <div className='container px-4'>
                <div className='flex mb-12 flex-col gap-4'>
                    <h3 className='text-4xl font-bold text-gray-900 dark:text-white tracking-tight'>Donghua Terbaru</h3>
                    <p className='text-gray-600 dark:text-gray-400 mt-3 text-lg'>Jelajahi koleksi donghua terbaru yang sedang tayang</p>
                </div>
