        ...
        <section className='py-10 sm:py-16'>
            ...
            <div className="container px-4 flex flex-col gap-6 md:gap-8">
                <div className='flex justify-between items-center gap-4 border-b border-gray-200 dark:border-gray-700 pb-4 md:pb-6'>
                    ...
                    <Link href={"/donghua/completed"} onClick={handleLinkClick} className='text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors duration-200 font-medium flex items-center gap-2'>
                        Lihat Semua
                ...
                <div className="relative">
                    ...
                    >
                        <div className="flex gap-3 sm:gap-4">
                            {completedAnichinData.data.animeList.map((donghua, idx) => (
                                <div
                                    key={idx}
